...
function addDepartment() {
    ...
    // Add the new department to the department selector
    const departmentSelector = document.getElementById('departmentSelector');
    const newDepartmentOption = document.createElement('option');
    newDepartmentOption.value = newDepartmentName;
    newDepartmentOption.text = newDepartmentName;
    departmentSelector.add(newDepartmentOption);
    saveDepartments();
...
const departmentSelect = document.getElementById('departmentSelector');
